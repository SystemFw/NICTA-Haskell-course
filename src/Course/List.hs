...
seqOptional =  foldRight (M.liftM2 (:.)) (P.pure Nil)  
...
lengthGT4 _ = False
--(>4) . length can't handle infinite lists
...
notReverse = reverse --impossible to satisfy the properties with anything but reverse
